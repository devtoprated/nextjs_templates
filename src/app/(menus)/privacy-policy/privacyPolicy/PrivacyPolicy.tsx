            ...
            <div className="privacyDoc">
              ...
              <ul className={styles.list}>
                ...
                <li>
                  ...
                  >
                    ...
                    Goby Homes, Inc., 13015 Britts Brook Lane, Waldorf, Maryland
                    20601.
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  >
                    <strong>Website</strong> refers to Goby Homes, accessible
                    from{" "}
                    <Link
                      className={cn(
                        styles.Privacy_link,
              ...
              <ul className={styles.list}>
                <li>
                  ...
                  >
                    By email: gobyhomesinc@gmail.com
                  </p>
                </li>
                <li>
                  <p
                  ...
                  >
                    ...
                    <a
                      ...
                      rel="external nofollow noopener"
                    >
                      https://gobyhomes.com/contact-us
                    </a>
                  </p>
                </li>
              </ul>
              ...
              >
                Our use of Google API user data complies with the Google API
                Services User Data Policy, including the Limited Use
                requirements. For more information, please see our privacy
                policy.
              </p>
              <p
                className={cn(
              ...
              >
                GobyHomes use and transfer of information received from Google
                ...
                <a
                  ...
                  href="https://gobyhomes.com/%E2%80%9Dhttps:/developers.google.com/terms/api-services-user-data-policy%E2%80%9D"
                  target="_blank"
                >
